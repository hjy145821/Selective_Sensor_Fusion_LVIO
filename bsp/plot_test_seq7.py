...
vo = pd.read_csv(r'D:\SZU\SLAM\results\vo\result_seq7_55.csv', delimiter=",")
vio = pd.read_csv(r'D:\SZU\SLAM\results\vio\hard\result_seq7_95.csv', delimiter=",")
lvio = pd.read_csv(r'D:\SZU\SLAM\results\lvio\direct\result_seq7_9.csv', delimiter=",")
# 提取xyz位移数据
...
# plt.plot(c_x, c_z, color='green', label='Result—raw')
plt.plot(rotated_result_vo[0], rotated_result_vo[1], color='blue', label='VIO')
plt.plot(rotated_result_vio[0], rotated_result_vio[1], color='green', label='LVIO')
plt.plot(rotated_result_lvio[0], rotated_result_lvio[1], color='yellow', label='LVIO')
# plt.plot(lvio_x, lvio_z, color='yellow', label='LVIO')
plt.xlabel("X")
plt.ylabel("Z")
