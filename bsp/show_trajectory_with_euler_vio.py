...
gt_pose_file = 'D:\\SLAM\\results\\vio\\hard-100\\truth_pose_seq7_7.csv'
gt_pose_data = np.loadtxt(gt_pose_file, delimiter=',')
gt_euler_file = 'D:\\SLAM\\results\\vio\\hard-100\\truth_euler_seq7_7.csv'
...
# VIO
for i in range(0,10):  # 从0到88
    lvio_result_file = f'D:\\SLAM\\results\\vio\\hard-100\\result_seq7_{i}.csv'
