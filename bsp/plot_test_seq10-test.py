...
# 读取位移数据
gt = pd.read_csv(r'D:\SLAM\results\lvio\direct\truth_pose_seq10_0.csv', delimiter=",")
vo = pd.read_csv(r'D:\SLAM\results\vo\result_seq10_55.csv', delimiter=",")
vio = pd.read_csv(r'D:\SLAM\results\vio\hard\result_seq10_95.csv', delimiter=",")
lvio = pd.read_csv(r'D:\SLAM\results\lvio\direct-100\result_seq10_49.csv', delimiter=",")

lvio_result_file = 'D:\\SLAM\\results\\lvio\\direct-50\\result_seq10_21.csv'
